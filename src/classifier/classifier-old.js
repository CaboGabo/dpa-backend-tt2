...
exports.resetTokensDel = async function(tokensDelimiters){
	tokensDel = tokensDel = [';', ',', '?', '¿', '!', '¡', ' y ', ' e ', ' o ', ' u ', ' ni '];
}

exports.setIntentMinScore = async function(minScore){
	intentMinScore = minScore;
}

exports.resetIntentMinScore = async function(minScore){
	intentMinScore = 0.98;
}
